              ...
              <div class="menu-state-bg menu-extended overflow-hidden overflow-lg-visible"
                ...
                <div class="row">
                  ...
                  <div class="col-lg-8 mb-3 mb-lg-0  py-3 px-3 py-lg-6 px-lg-6">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6 mb-3">
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="indexd09c.html?page=dashboards/ecommerce"
                             class="menu-link ">
                                <span
                                  class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                      ...
                      <div class="col-lg-6 mb-3">
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="index13c3.html?page=dashboards/projects"
                             class="menu-link ">
                                <span
                                  class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                      ...
                      <div class="col-lg-6 mb-3">
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="index7ecf.html?page=dashboards/online-courses"
                             class="menu-link ">
                                <span
                                  class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                      ...
                      <div class="col-lg-6 mb-3">
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="indexbc69.html?page=dashboards/marketing"
                             class="menu-link ">
                                <span
                                  class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                    <i class="ki-duotone ki-chart-simple text-gray-900 fs-1"><span class="path1"></span><span
                                        class="path2"></span><span class="path3"></span><span class="path4"></span></i>                                </span>
                      ...
                      <div class="col-lg-6 mb-3">
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="index9a3c.html?page=dashboards/bidding"
                             class="menu-link ">
                                <span
                                  class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                      ...
                      <div class="col-lg-6 mb-3">
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="index7568.html?page=dashboards/pos"
                             class="menu-link ">
                                <span
                                  class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                      ...
                      <div class="col-lg-6 mb-3">
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="indexb514.html?page=dashboards/call-center"
                             class="menu-link ">
                                <span
                                  class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                    ...
                    <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-2 mx-5">
                      ...
                      <a href="index694c.html?page=landing"
                  ...
                  <div
                    ...
                    <div class="menu-item p-0 m-0">
                      <!--begin:Menu link-->
                      <a href="index273f.html?page=dashboards/logistics"
                    ...
                    <div class="menu-item p-0 m-0">
                      <!--begin:Menu link-->
                      <a href="index6eda.html?page=dashboards/website-analytics"
                         class="menu-link py-2 ">
                        <span class="menu-title">
                    ...
                    <div class="menu-item p-0 m-0">
                      <!--begin:Menu link-->
                      <a href="indexd05a.html?page=dashboards/finance-performance"
                         class="menu-link py-2 ">
                        <span class="menu-title">
                    ...
                    <div class="menu-item p-0 m-0">
                      <!--begin:Menu link-->
                      <a href="index06c5.html?page=dashboards/store-analytics"
                         class="menu-link py-2 ">
                        <span class="menu-title">
                    ...
                    <div class="menu-item p-0 m-0">
                      <!--begin:Menu link-->
                      <a href="index6425.html?page=dashboards/social"
                         class="menu-link py-2 ">
                        <span class="menu-title">
                            Social                        </span>
                      </a>
                    ...
                    <div class="menu-item p-0 m-0">
                      <!--begin:Menu link-->
                      <a href="indexf1aa.html?page=dashboards/delivery"
                         class="menu-link py-2 ">
                        <span class="menu-title">
                            Delivery                        </span>
                      </a>
                    ...
                    <div class="menu-item p-0 m-0">
                      <!--begin:Menu link-->
                      <a href="index5fb2.html?page=dashboards/crypto"
                         class="menu-link py-2 ">
                        <span class="menu-title">
                            Crypto                        </span>
                      </a>
                    ...
                    <div class="menu-item p-0 m-0">
                      <!--begin:Menu link-->
                      <a href="index8a0b.html?page=dashboards/school"
                         class="menu-link py-2 ">
                        <span class="menu-title">
                            School                        </span>
                      </a>
                    ...
                    <div class="menu-item p-0 m-0">
                      <!--begin:Menu link-->
                      <a href="index65bc.html?page=dashboards/podcast"
                         class="menu-link py-2 ">
                        <span class="menu-title">
                            Podcast                        </span>
                      </a>
                      ...
                      <div class="col-lg-8">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-3 mb-6 mb-lg-0">
                            ...
                            <div class="menu-item p-0 m-0">
                              <!--begin:Menu link-->
                              <a href="indexe6a0.html?page=pages/user-profile/campaigns"
                                 class="menu-link ">
                            ...
                            <div class="menu-item p-0 m-0">
                              <!--begin:Menu link-->
                              <a href="index30d7.html?page=pages/user-profile/documents"
                                 class="menu-link ">
                            ...
                            <div class="menu-item p-0 m-0">
                              <!--begin:Menu link-->
                              <a href="index1142.html?page=pages/user-profile/followers"
                                 class="menu-link ">
                          ...
                          <div class="col-lg-3 mb-6 mb-lg-0">
                            ...
                            <div class="mb-6">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="indexe720.html?page=pages/about"
                                   class="menu-link ">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index5804.html?page=pages/team"
                                   class="menu-link ">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index11bd.html?page=pages/contact"
                                   class="menu-link ">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="indexcc30.html?page=pages/licenses"
                                   class="menu-link ">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index1be0.html?page=pages/sitemap"
                                   class="menu-link ">
                            ...
                            <div class="mb-0">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="indexef10.html?page=pages/careers/list"
                                   class="menu-link ">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="indexd3f9.html?page=pages/careers/apply"
                                   class="menu-link ">
                                                                            <span
                          ...
                          <div class="col-lg-3 mb-6 mb-lg-0">
                            ...
                            <div class="mb-6">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index130b.html?page=pages/faq/classic"
                                   class="menu-link ">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index2259.html?page=pages/faq/extended"
                                   class="menu-link ">
                            ...
                            <div class="mb-6">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index4496.html?page=pages/blog/home"
                                   class="menu-link ">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index59af.html?page=pages/blog/post"
                                   class="menu-link ">
                            ...
                            <div class="mb-0">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index2ab2.html?page=pages/pricing"
                                   class="menu-link ">
                                                                            <span
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="indexb98f.html?page=pages/pricing/table"
                                   class="menu-link ">
                                                                            <span
                          ...
                          <div class="col-lg-3 mb-6 mb-lg-0">
                            ...
                            <div class="mb-0">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index6bb4.html?page=pages/social/feeds"
                                   class="menu-link ">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index89e4.html?page=pages/social/activity"
                                   class="menu-link ">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index28cf.html?page=pages/social/followers"
                                   class="menu-link ">
                                  <span class="menu-title">Followers</span>
                                </a>
                                <!--end:Menu link-->
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index3ea5.html?page=pages/social/settings"
                                   class="menu-link ">
                      ...
                      <div class="col-lg-5 mb-6 mb-lg-0">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-6">
                            ...
                            <div class="menu-item p-0 m-0">
                              <!--begin:Menu link-->
                              <a href="index3164.html?page=account/overview"
                                 class="menu-link ">
                                <span class="menu-title">Overview</span>
                              </a>
                              <!--end:Menu link-->
                            ...
                            <div class="menu-item p-0 m-0">
                              <!--begin:Menu link-->
                              <a href="indexbbde.html?page=account/security"
                                 class="menu-link ">
                            ...
                            <div class="menu-item p-0 m-0">
                              <!--begin:Menu link-->
                              <a href="index93d4.html?page=account/billing"
                                 class="menu-link ">
                          ...
                          <div class="col-lg-6">
                            ...
                            <div class="menu-item p-0 m-0">
                              <!--begin:Menu link-->
                              <a href="indexe638.html?page=account/referrals"
                                 class="menu-link ">
                            ...
                            <div class="menu-item p-0 m-0">
                              <!--begin:Menu link-->
                              <a href="index93a9.html?page=account/api-keys"
                                 class="menu-link ">
                            ...
                            <div class="menu-item p-0 m-0">
                              <!--begin:Menu link-->
                              <a href="indexcf4a.html?page=account/logs"
                                 class="menu-link ">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-3 mb-6 mb-lg-0">
                        ...
                        <div class="mb-6">
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index63bb.html?page=authentication/layouts/corporate/sign-up"
                               class="menu-link ">
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index20c3.html?page=authentication/layouts/corporate/two-factor"
                               class="menu-link ">
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index6e50.html?page=authentication/layouts/corporate/reset-password"
                               class="menu-link ">
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index8d98.html?page=authentication/layouts/corporate/new-password"
                               class="menu-link ">
                        ...
                        <div class="mb-0">
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index4830.html?page=authentication/layouts/overlay/sign-in"
                               class="menu-link ">
                              <span class="menu-title">Sign-In</span>
                            </a>
                            <!--end:Menu link-->
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index847e.html?page=authentication/layouts/overlay/sign-up"
                               class="menu-link ">
                              <span class="menu-title">Sign-Up</span>
                            </a>
                            <!--end:Menu link-->
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index5e73.html?page=authentication/layouts/overlay/two-factor"
                               class="menu-link ">
                              <span class="menu-title">Two-Factor</span>
                            </a>
                            <!--end:Menu link-->
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index3438.html?page=authentication/layouts/overlay/reset-password"
                               class="menu-link ">
                              <span class="menu-title">Reset Password</span>
                            </a>
                            <!--end:Menu link-->
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="indexd8a0.html?page=authentication/layouts/overlay/new-password"
                               class="menu-link ">
                              <span class="menu-title">New Password</span>
                            </a>
                            <!--end:Menu link-->
                      ...
                      <div class="col-lg-3 mb-6 mb-lg-0">
                        ...
                        <div class="mb-6">
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index8500.html?page=authentication/layouts/creative/sign-in"
                               class="menu-link ">
                              <span class="menu-title">Sign-in</span>
                            </a>
                            <!--end:Menu link-->
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="indexee93.html?page=authentication/layouts/creative/sign-up"
                               class="menu-link ">
                              <span class="menu-title">Sign-up</span>
                            </a>
                            <!--end:Menu link-->
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index9433.html?page=authentication/layouts/creative/two-factor"
                               class="menu-link ">
                              <span class="menu-title">Two-Factor</span>
                            </a>
                            <!--end:Menu link-->
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index76d3.html?page=authentication/layouts/creative/reset-password"
                               class="menu-link ">
                              <span class="menu-title">Reset Password</span>
                            </a>
                            <!--end:Menu link-->
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="indexa9ba.html?page=authentication/layouts/creative/new-password"
                               class="menu-link ">
                              <span class="menu-title">New Password</span>
                            </a>
                            <!--end:Menu link-->
                        ...
                        <div class="mb-6">
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index6c31.html?page=authentication/layouts/fancy/sign-in"
                               class="menu-link ">
                              <span class="menu-title">Sign-In</span>
                            </a>
                            <!--end:Menu link-->
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index7ebb.html?page=authentication/layouts/fancy/sign-up"
                               class="menu-link ">
                              <span class="menu-title">Sign-Up</span>
                            </a>
                            <!--end:Menu link-->
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="indexcab9.html?page=authentication/layouts/fancy/two-factor"
                               class="menu-link ">
                              <span class="menu-title">Two-Factor</span>
                            </a>
                            <!--end:Menu link-->
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="indexa99b.html?page=authentication/layouts/fancy/reset-password"
                               class="menu-link ">
                              <span class="menu-title">Reset Password</span>
                            </a>
                            <!--end:Menu link-->
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index31a1.html?page=authentication/layouts/fancy/new-password"
                               class="menu-link ">
                              <span class="menu-title">New Password</span>
                            </a>
                            <!--end:Menu link-->
                      ...
                      <div class="col-lg-3 mb-6 mb-lg-0">
                        ...
                        <div class="mb-0">
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index48a8.html?page=authentication/extended/multi-steps-sign-up"
                               class="menu-link ">
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index33bb.html?page=authentication/general/welcome"
                               class="menu-link ">
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="indexd381.html?page=authentication/general/verify-email"
                               class="menu-link ">
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="indexdcf9.html?page=authentication/general/coming-soon"
                               class="menu-link ">
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index0340.html?page=authentication/general/password-confirmation"
                               class="menu-link ">
                                                                    <span
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index7ea0.html?page=authentication/general/account-deactivated"
                               class="menu-link ">
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index6407.html?page=authentication/general/error-404"
                               class="menu-link ">
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index6147.html?page=authentication/general/error-500"
                               class="menu-link ">
                      ...
                      <div class="col-lg-3 mb-6 mb-lg-0">
                        ...
                        <div class="mb-0">
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index5f9e.html?page=authentication/email/welcome-message"
                               class="menu-link ">
                              <span class="menu-title">Welcome Message</span>
                            </a>
                            <!--end:Menu link-->
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index42a2.html?page=authentication/email/reset-password"
                               class="menu-link ">
                              <span class="menu-title">Reset Password</span>
                            </a>
                            <!--end:Menu link-->
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="indexbbd7.html?page=authentication/email/subscription-confirmed"
                               class="menu-link ">
                                                                    <span
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index66c8.html?page=authentication/email/card-declined"
                               class="menu-link ">
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index4274.html?page=authentication/email/promo-1"
                               class="menu-link ">
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index8d42.html?page=authentication/email/promo-2"
                               class="menu-link ">
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a href="index49fa.html?page=authentication/email/promo-3"
                               class="menu-link ">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-4 mb-6 mb-lg-0">
                            ...
                            <div class="mb-0">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="indexcbca.html?page=utilities/modals/general/invite-friends"
                                   class="menu-link ">
                                                                            <span
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index6d1e.html?page=utilities/modals/general/view-users"
                                   class="menu-link ">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index1eca.html?page=utilities/modals/general/select-users"
                                   class="menu-link ">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index7025.html?page=utilities/modals/general/upgrade-plan"
                                   class="menu-link ">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index90cb.html?page=utilities/modals/general/share-earn"
                                   class="menu-link ">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index6c59.html?page=utilities/modals/forms/new-target"
                                   class="menu-link ">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="indexbb84.html?page=utilities/modals/forms/new-card"
                                   class="menu-link ">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index40d2.html?page=utilities/modals/forms/new-address"
                                   class="menu-link ">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index2b78.html?page=utilities/modals/forms/create-api-key"
                                   class="menu-link ">
                                                                            <span
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index9b2f.html?page=utilities/modals/forms/bidding"
                                   class="menu-link ">
                          ...
                          <div class="col-lg-4 mb-6 mb-lg-0">
                            ...
                            <div class="mb-6">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index1226.html?page=utilities/modals/wizards/create-app"
                                   class="menu-link ">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index3d8e.html?page=utilities/modals/wizards/create-campaign"
                                   class="menu-link ">
                                                                            <span
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index7814.html?page=utilities/modals/wizards/create-account"
                                   class="menu-link ">
                                                                            <span
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="indexde37.html?page=utilities/modals/wizards/create-project"
                                   class="menu-link ">
                                                                            <span
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index898b.html?page=utilities/modals/wizards/top-up-wallet"
                                   class="menu-link ">
                                                                            <span
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index37df.html?page=utilities/modals/wizards/offer-a-deal"
                                   class="menu-link ">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index8e77.html?page=utilities/modals/wizards/two-factor-authentication"
                                   class="menu-link ">
                                                                            <span
                            ...
                            <div class="mb-0">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="indexb6a8.html?page=utilities/search/vertical"
                                   class="menu-link ">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="indexe83e.html?page=utilities/modals/search/users"
                                   class="menu-link ">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index2018.html?page=utilities/modals/search/select-location"
                                   class="menu-link ">
                                                                            <span
                          ...
                          <div class="col-lg-4 mb-6 mb-lg-0">
                            ...
                            <div class="mb-0">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index4f6e.html?page=utilities/wizards/horizontal"
                                   class="menu-link ">
                                  <span class="menu-title">Horizontal</span>
                                </a>
                                <!--end:Menu link-->
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="indexee7d.html?page=utilities/wizards/vertical"
                                   class="menu-link ">
                                  <span class="menu-title">Vertical</span>
                                </a>
                                <!--end:Menu link-->
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="indexc10a.html?page=utilities/wizards/two-factor-authentication"
                                   class="menu-link ">
                                                                            <span
                                                                              class="menu-title">Two Factor Auth</span>
                                </a>
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index0e95.html?page=utilities/wizards/create-app"
                                   class="menu-link ">
                                  <span class="menu-title">Create App</span>
                                </a>
                                <!--end:Menu link-->
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="indexb058.html?page=utilities/wizards/create-campaign"
                                   class="menu-link ">
                                                                            <span
                                                                              class="menu-title">Create Campaign</span>
                                </a>
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index8fbd.html?page=utilities/wizards/create-account"
                                   class="menu-link ">
                                                                            <span
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="indexbd20.html?page=utilities/wizards/create-project"
                                   class="menu-link ">
                                                                            <span
                                                                              class="menu-title">Create Project</span>
                                </a>
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="index16b7.html?page=utilities/wizards/offer-a-deal"
                                   class="menu-link ">
                                  <span class="menu-title">Offer a Deal</span>
                                </a>
                                <!--end:Menu link-->
                  ...
                  <div class="tab-pane  w-lg-500px" id="kt_app_header_menu_pages_widgets">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-4 mb-6 mb-lg-0">
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="index990a.html?page=widgets/lists"
                             class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="index3373.html?page=widgets/statistics"
                             class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="index3c0a.html?page=widgets/charts"
                             class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="index0afd.html?page=widgets/mixed"
                             class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="indexd38d.html?page=widgets/tables"
                             class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="indexa8b9.html?page=widgets/feeds"
                             class="menu-link ">
                            <span class="menu-title">Feeds</span>
                          </a>
                          <!--end:Menu link-->
            ...
            <div
              ...
              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                ...
                <div
                  ...
                  <!--end:Menu item--><!--begin:Menu item-->
                  <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                                                  href="indexe489.html?page=apps/inbox/reply"><span
                        class="menu-bullet"><span
                          class="bullet bullet-dot"></span></span><span
              ...
              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                ...
                <div
                  ...
                  <!--begin:Menu item-->
                  <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                                                  href="index97cc.html?page=apps/chat/private"><span
                        class="menu-bullet"><span
                          class="bullet bullet-dot"></span></span><span
                        class="menu-title">Private Chat</span></a><!--end:Menu link-->
                  </div><!--end:Menu item--><!--begin:Menu item-->
                  <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                                                  href="indexaf8d.html?page=apps/chat/group"><span
                        class="menu-bullet"><span
                          class="bullet bullet-dot"></span></span><span
                        class="menu-title">Group Chat</span></a><!--end:Menu link-->
                  </div><!--end:Menu item--><!--begin:Menu item-->
                  <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                                                  href="indexadf9.html?page=apps/chat/drawer"><span
                        class="menu-bullet"><span
                          class="bullet bullet-dot"></span></span><span
              ...
              <!--end:Menu item--><!--begin:Menu item-->
              <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                                                              href="indexb037.html?page=apps/calendar"><span
                  ...
                  <div class="col-lg-7">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-4 mb-3">
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="index121c.html?page=layouts/light-sidebar"
                             class="menu-link ">
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="index639b.html?page=layouts/dark-sidebar"
                             class="menu-link ">
                                                                <span class="menu-bullet"><span
                                                                    class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="index59c3.html?page=layouts/light-header"
                             class="menu-link ">
                                                                <span class="menu-bullet"><span
                                                                    class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="index8379.html?page=layouts/dark-header"
                             class="menu-link ">
                                                                <span class="menu-bullet"><span
                                                                    class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                      ...
                      <div class="col-lg-4 mb-3">
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="index401e.html?page=toolbars/classic"
                             class="menu-link ">
                                                                <span class="menu-bullet"><span
                                                                    class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="index39ed.html?page=toolbars/saas"
                             class="menu-link ">
                                                                <span class="menu-bullet"><span
                                                                    class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="indexed30.html?page=toolbars/accounting"
                             class="menu-link ">
                                                                <span class="menu-bullet"><span
                                                                    class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="indexbd67.html?page=toolbars/extended"
                             class="menu-link ">
                                                                <span class="menu-bullet"><span
                                                                    class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="index3b79.html?page=toolbars/reports"
                             class="menu-link ">
                                                                <span class="menu-bullet"><span
                                                                    class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                      ...
                      <div class="col-lg-4 mb-3">
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="index0483.html?page=asides/aside-1"
                             class="menu-link ">
                                                                <span class="menu-bullet"><span
                                                                    class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="index65b1.html?page=asides/aside-2"
                             class="menu-link ">
                                                                <span class="menu-bullet"><span
                                                                    class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="index493d.html?page=asides/aside-3"
                             class="menu-link ">
                                                                <span class="menu-bullet"><span
                                                                    class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="indexa84e.html?page=asides/aside-4"
                             class="menu-link ">
                                                                <span class="menu-bullet"><span
                                                                    class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                        ...
                        <div class="menu-item p-0 m-0">
                          <!--begin:Menu link-->
                          <a href="index7eba.html?page=asides/aside-5"
                             class="menu-link ">
                                                                <span class="menu-bullet"><span
                                                                    class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
          ...
          <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
            ...
            <div
              ...
              <div class="menu-item"><!--begin:Menu link--><a class="menu-link"
                    ...
                    class="menu-title">Changelog v8.3.3</span></a><!--end:Menu link--></div>
                ...
                <div class="scroll-y mh-325px my-5 px-8">
                  ...
                  <div class="d-flex flex-stack py-4">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="symbol symbol-35px me-4">
                                <span class="symbol-label bg-light-primary">
                                    <i class="ki-duotone ki-colors-square fs-2 text-primary"><span class="path1"></span><span
                                        class="path2"></span><span class="path3"></span><span class="path4"></span></i>
                                </span>
                      </div>
                      <!--end::Symbol-->
